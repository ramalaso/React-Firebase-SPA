                ...
                <div className="container text-center">
                    <div className="row justify-content-center">
                        ...
                        </p>
                        {
                            user == null && (
                                <span>
                                    <Link to="/register" className="btn btn-outline-primary mr-2 px-5">Register</Link>
                                    <Link to="/login" className="btn btn-outline-primary mr-2 px-5">Login</Link>
                                </span>
                            )
                        }
                        {
                            user && (
                                <Link to="/meetings" className="btn btn-primary px-5">Meetings</Link>
                            )
                        }
                        </div>
                    </div>
